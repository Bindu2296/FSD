...
const ProjectSchema = new mongoose.Schema({
    ...
    domain : mongoose.SchemaTypes.String,
    employees: [  {id: mongoose.SchemaTypes.Number,
        name: mongoose.SchemaTypes.String,
        salary : mongoose.SchemaTypes.Number,
        des: mongoose.SchemaTypes.String,
    } ]
})
// Step 4: build Employee Model
const Employee = mongoose.model('employee',ProjectSchema)
